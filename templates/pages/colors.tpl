...
#{
  ...
  val colorIndex                = model.parameters.getSingleValue("theme", "4").toInt
            ...
            <td height="730" style="width: 80%; background-color: ${backgroundColors(colorIndex)};" valign="top">
	            <div style="margin-left: 40px; margin-right: 40px; margin-top: 10px;">
	               ...
	               <table cellpadding="0" cellspacing="0" style="margin: 0px; padding: 0px; margin-top: 40px;">
			            <tr><td width="500"><h1><span class="emphasized">${font.displayName}</span></h1></td><td><h1><span style="color: #00476E; padding-left: 20px;">Rag. Dette & Kern. Hamburg 1290.</span></h1></td></tr>
		               <tr><td><h2><span class="emphasized">${font.displayName}</span></h2></td><td><h2><span style="color: #00476E; padding-left: 20px;">Rag. Dette & Kern. Hamburg 1290.</span></h2></td></tr>
		               <tr><td><h3><span class="emphasized">${font.displayName}</span></h3></td><td><h3><span style="color: #00476E; padding-left: 20px;">Rag. Dette & Kern. Hamburg 1290.</span></h3></td></tr>
		               <tr><td><h4><span class="emphasized">${font.displayName}</span></h4></td><td><h4><span style="color: #00476E; padding-left: 20px;">Rag. Dette & Kern. Hamburg 1290.</span></h4></td></tr>
		               <tr><td><h5><span class="emphasized">${font.displayName}</span></h5></td><td><h5><span style="color: #00476E; padding-left: 20px;">Rag. Dette & Kern. Hamburg 1290.</span></h5></td></tr>
		               <tr>
		                  <td></td>
