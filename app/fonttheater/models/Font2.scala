...
class Font2(
             ...
             val letterSpacingFactor: Double = Font2.defaultLetterSpacingFactor) {

  def this(name: String, fontSource: FontSource2, letterSpacingFactor: Double = Font2.defaultLetterSpacingFactor) =
    this(name, name, Defaults.weightName, Defaults.weight, fontSource, letterSpacingFactor)

  def this(name: String, displayName: String = null, fontSource: FontSource2, letterSpacingFactor: Double = Font2.defaultLetterSpacingFactor) =
